...
# Split the window and run DataNode in the second pane
tmux split-window -h
tmux send-keys "cd ../test/test_datanode2 && ./DataNode" C-m

# Split the window and run DataNode in the second pane
tmux split-window -h
tmux send-keys "cd ../test/test_datanode3 && ./DataNode" C-m
...
tmux split-window -v
tmux send-keys "cd ../test/test_client2 && ./SquidStorage" C-m
